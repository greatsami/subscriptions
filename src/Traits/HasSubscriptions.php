...
namespace Gratesami\Subscriptions\Traits;
...
trait HasSubscriptions
{
    ...
    {
        return $this->morphMany(config('gratesami.subscriptions.models.plan_subscription'), 'user');
    }
     ...
     *
     * @return \Gratesami\Subscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): ?PlanSubscription
    {
        ...
        return app('gratesami.subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \Gratesami\Subscriptions\Models\PlanSubscription
     */
